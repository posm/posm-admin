...
POSM itself generates tiles, called _POSM Carto_ on the device itself, but it is often useful to have the HOT Export Tool fetch tiles for you in the internet as well--especially if you want to have a satellite basemap.
